...
// TODO: расчет под 6.9% годовых должен расчитываться за каждый год, а не за 3 сразу
...
function getImageCoin(number){
  return `ac-coin-${imageId}.svg`;
}

// Расчитываем шаг для добавления монеток
function getCoinStep(sum){
  return;
}
